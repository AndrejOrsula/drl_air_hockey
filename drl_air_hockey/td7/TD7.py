...
import drl_air_hockey.td7.buffer as buffer
...
class Agent(object):
    def __init__(
        self, state_dim, action_dim, max_action, offline=False, hp=Hyperparameters()
    ):
        ...
        self.critic_optimizer = torch.optim.Adam(
            self.critic.parameters(), lr=hp.critic_lr
        )
        ...
        self.encoder_optimizer = torch.optim.Adam(
            self.encoder.parameters(), lr=hp.encoder_lr
        )
